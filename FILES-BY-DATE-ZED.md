...
Dates come from the latest upstream Git commit that changed each tracked file, grouped in the Denver timezone.
Generated or rewritten files excluded from this manifest are intentionally omitted.
...
- `crates/gpui_apple/src/metal_atlas.rs`
...
- `.wezel/config.toml`
- `.wezel/experiments/binary-size/experiment.toml`
- `.wezel/schema.json`
- `.wezel/wezel.lock`
...
- `crates/ztracing_macro/Cargo.toml`
- `tooling/corgi/patches/scratch/Cargo.toml`
- `tooling/corgi/patches/scratch/LICENSE-APACHE`
...
- `crates/gpui/src/profiler/hang.rs`
- `crates/gpui/src/profiler/journal.rs`
- `crates/gpui/src/queue.rs`
- `crates/gpui/src/text_system.rs`
- `crates/gpui/src/text_system/line.rs`
- `crates/gpui_macos/src/screen_capture.rs`
- `crates/gpui_platform/benches/inspector_render.rs`
- `crates/gpui_web/examples/hello_web/Cargo.toml`
- `crates/gpui_web/examples/hello_web/font_fallback_test.rs`
- `crates/gpui_web/examples/hello_web/index.html`
- `crates/gpui_web/examples/hello_web/queue_test.rs`
- `crates/gpui_web/examples/hello_web/test_canvas_fallback.mjs`
- `crates/gpui_web/examples/hello_web/test_queue.mjs`
- `crates/gpui_web/src/canvas_fallback.rs`
- `crates/gpui_web/src/dispatcher.rs`
- `crates/gpui_web/src/run_replacements.rs`
- `crates/gpui_web/src/text_system.rs`
...
- `crates/gpui_windows/src/dialog.rs`
- `crates/gpui_windows/src/gpui_windows.rs`

## 2026-09-14

- `crates/gpui/examples/README.md`
- `crates/gpui_web/examples/hello_web/dynamic_fonts.rs`

## 2026-09-12

- `crates/gpui/examples/text.rs`
- `crates/gpui_linux/src/linux/wayland/client.rs`
- `crates/gpui_web/examples/hello_web/gallery.js`
- `crates/gpui_web/examples/hello_web/trunk.toml`
- `crates/gpui_web/src/canvas_text.rs`
- `crates/gpui_web/src/glyph_cache.rs`
...
- `crates/gpui_web/src/ime_mirror.rs`
- `crates/gpui_web/src/viewport.rs`
...
- `crates/gpui/examples/example_support/fonts.rs`
...
- `crates/gpui/examples/system_notifications.rs`
...
- `tooling/lints/src/map_lookup_then_insert.rs`
...
- `crates/ztracing/src/web.rs`

## 2026-08-19

- `crates/gpui_web/src/http_client.rs`
- `crates/path/src/path.rs`
...
- `crates/gpui/src/debug_overlay.rs`
...
- `crates/gpui_apple/LICENSE-APACHE`
- `crates/gpui_apple/src/gpui_apple.rs`
...
- `crates/gpui_wgpu/src/shaders_storage.wgsl`
...
- `crates/gpui/examples/image/exif-orientation-rotate-180.jpg`
- `crates/gpui_linux/src/linux.rs`
- `crates/gpui_linux/src/linux/system_notifications.rs`
- `crates/gpui_macos/src/system_notifications.rs`
- `crates/gpui_windows/src/system_notifications.rs`

## 2026-07-15

- `crates/path/LICENSE-APACHE`
- `crates/path/src/abs_path.rs`
- `crates/path/src/rel_path.rs`
...
- `crates/gpui/src/window/a11y/debug.rs`
...
- `crates/gpui/src/platform/layer_shell.rs`
- `crates/gpui_linux/LICENSE-APACHE`
- `crates/gpui_linux/src/gpui_linux.rs`
- `crates/gpui_linux/src/linux/keyboard.rs`
- `crates/gpui_linux/src/linux/wayland/layer_shell.rs`
- `crates/gpui_linux/src/linux/x11.rs`
- `crates/gpui_linux/src/linux/x11/event.rs`
- `crates/gpui_linux/src/linux/x11/xim_handler.rs`
