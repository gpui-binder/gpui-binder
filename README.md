...
gpui = { git = "https://github.com/gpui-binder/gpui-binder", package = "gpui_facade", rev = "97e56f6280eec4832f93b73803a51347a15c4c25", default-features = false, features = ["gpui_macros"] }
gpui-component = { git = "https://github.com/gpui-binder/gpui-binder", package = "gpui-component", rev = "97e56f6280eec4832f93b73803a51347a15c4c25" }
```
